const ReportsStats = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 font-body">
      {/* Total Reports */}
      <div className="bg-surface-container-low p-6 rounded-xl relative overflow-hidden group border border-on-surface/10/50 shadow-lg">
        <div className="relative z-10">
          <span className="text-[10px] text-on-surface uppercase tracking-widest font-black">Total Reports</span>
      ...
      <div className="bg-surface-container-low p-6 rounded-xl relative overflow-hidden group border border-on-surface/10/50 shadow-lg">
        <div className="relative z-10">
          <span className="text-[10px] text-on-surface uppercase tracking-widest font-black">Data Accuracy</span>
      ...
      <div className="md:col-span-2 bg-surface-container-low rounded-xl overflow-hidden flex border border-on-surface/10/50 shadow-lg">
        <div className="p-6 flex-1">
          <span className="text-[10px] text-on-surface uppercase tracking-widest font-black">System Health</span>
          ...
          <div className="flex justify-between mt-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold text-on-surface uppercase tracking-tighter">Active (4,821)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-primary shadow-[0_0_8px_rgba(148,204,255,0.5)]"></div>
              <span className="text-[10px] font-bold text-on-surface uppercase tracking-tighter">Maint (142)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-error shadow-[0_0_8px_rgba(255,180,171,0.5)]"></div>
              <span className="text-[10px] font-bold text-on-surface uppercase tracking-tighter">Error (12)</span>
            </div>
          </div>
        </div>
        <div className="w-32 bg-surface-container-high/50 flex items-center justify-center border-l border-on-surface/5">
          <span className="material-symbols-outlined text-4xl text-on-surface/30 font-light">hub</span>
        </div>
      </div>
    </div>
  );
