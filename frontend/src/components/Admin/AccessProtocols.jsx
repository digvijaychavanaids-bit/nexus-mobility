const AccessProtocols = () => {
  return (
    <div className="bg-surface-container rounded-xl p-6 relative overflow-hidden group shadow-lg border border-on-surface/10/50 font-body">
      ...
      <p className="text-xs text-on-surface leading-relaxed font-medium">Your account has root-level permissions. All actions are logged and subject to audit by the Central Governing Entity.</p>
      ...
      <div className="mt-6 flex items-center gap-4">
        <div className="flex -space-x-2">
          ...
          <div className="w-8 h-8 rounded-full border-2 border-slate-900 bg-surface-container-high flex items-center justify-center text-[8px] font-black text-on-surface">+4</div>
        </div>
        <p className="text-[10px] text-on-surface font-black uppercase tracking-widest">Other root admins online</p>
      </div>
    </div>
  );
};
