...
const SmartSignals = () => {
  ...
  return (
    ...
    >
      ...
      <footer className="pt-16 border-t border-on-surface/5 flex flex-col md:flex-row items-center justify-between gap-8 text-[11px] font-black text-on-surface uppercase tracking-[0.4em] opacity-20">
